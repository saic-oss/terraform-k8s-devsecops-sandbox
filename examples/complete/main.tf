...
module "rke_rancher_master_cluster" {
  source                          = "git::https://code.saicinnovationfactory.com/dau/move-to-repo-one/terraform-modules/terraform-aws-rke-rancher-master-cluster.git?ref=tags/0.1.0"
  additional_tag_map              = {}
...
module "rancher-k8s-cluster" {
  source                     = "git::https://code.saicinnovationfactory.com/dau/move-to-repo-one/terraform-modules/terraform-aws-rancher-k8s-cluster.git?ref=tags/0.4.0"
  additional_tag_map         = {}
